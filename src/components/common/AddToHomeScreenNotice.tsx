  ...
  if (isDismissed) {
    return (
      <>
        ...
        <div className="flex items-center justify-between px-3.5 py-2 rounded-2xl bg-slate-50 dark:bg-slate-900/80 border border-sky-500/20 backdrop-blur-md text-xs text-slate-700 dark:text-slate-300">
          <div className="flex items-center gap-2">
            <img referrerPolicy="no-referrer"               src={appIconImg} 
              alt="AzurLize Icon" 
              className="w-5 h-5 rounded-md object-cover border border-sky-500/30 shrink-0" 
            />
            <span>Akses Cepat: <strong className="text-slate-900 dark:text-white">Tambah ke Beranda HP</strong></span>
          </div>
          <button
  ...
  return (
    <>
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-sky-950/80 via-slate-900/90 to-blue-950/80 border border-sky-500/30 p-4 shadow-lg shadow-sky-950/40 backdrop-blur-md animate-in fade-in duration-300">
        ...
        <div className="flex items-start justify-between gap-3 relative z-10">
          <div className="flex items-start gap-3">
            ...
            <div className="space-y-1">
              <div className="flex items-center gap-2">
                <h4 className="text-xs md:text-sm font-bold text-slate-900 dark:text-white tracking-tight">
          ...
          <button
            ...
            className="p-1 rounded-lg text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:text-white hover:bg-slate-100 dark:bg-slate-800 transition-colors cursor-pointer shrink-0"
            title="Sembunyikan"
          >
            <X className="w-4 h-4" />
          </button>
        ...
        <div className="mt-3 pt-3 border-t border-slate-200 dark:border-slate-800/80 flex items-center justify-between gap-2 text-[11px]">
          <div className="flex items-center gap-1.5 text-slate-600 dark:text-slate-400">
            <span>Panduan:</span>
            <span className="inline-flex items-center gap-1 px-1.5 py-0.5 rounded bg-slate-100 dark:bg-slate-800 text-slate-200 font-mono text-[10px]">
