...
export const GlassCard: React.FC<GlassCardProps> = ({
  ...
  return (
    <div
      onClick={onClick}
      className={`rounded-[22px] p-5 border border-slate-200/80 dark:border-white/10 bg-white/90 dark:bg-slate-900/80 shadow-sm dark:shadow-xl backdrop-blur-xl transition-all duration-300 relative overflow-hidden text-slate-900 dark:text-slate-100 ${
